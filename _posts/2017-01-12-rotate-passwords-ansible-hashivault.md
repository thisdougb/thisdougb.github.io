...
A full-fat automation approach of course.   The image below shows the runtime auth against HashiVault of a password rotation playbook as an AD authenticated user.   User _ian_ being authorised to rotate passwords, and user _dervla_ not being authorised.
