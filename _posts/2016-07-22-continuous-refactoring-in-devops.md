---
layout: post
title: Continuous Refactoring In DevOps
permalink: /devops/continuous-refactoring-in-devops
...
The application owner had long since left the company, and with them any hope of identifying what the PC was actually doing or its login.
...
Bits of virtual infrastructure are being left active in the wake of rapid Agile projects, as they up-version their way into production.

Therefore, agility and progress is more pragmatically measured not in your newest piece of infrastructure widget, but the age of your oldest.
...
And it's this degree of friction, albeit unmeasurable, that indicates how valuable an agile workflow is to the business.
...
Importantly the code is more readable by someone else, and easier to understand when you come back after a break.
...
The benefits to software development teams (of cyclomatic complexity) are well known, and we can have similar gains when developing infrastructure as code.
...
A sort of cleaner style of DevOps...
