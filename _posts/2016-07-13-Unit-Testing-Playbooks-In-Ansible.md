...
---
I confess that I am not excited about the idea of testing Ansible roles.
...
Frequently enough that roles were being written from scratch, deemed more expdient than unpicking role-spaghetti.
...
If this rolls out to our production environment, or taking out our dev environment, it's not good.
...
I prefer the tight association of unit tests with the object of the test, so *'task > unitTest > task > unitTest'* within the same .yml file.
This suits my preferred style of building roles (thought of as components) as small units of work.
So effectively doubling the size of the role with unitTest code preserves readability.
...
Tags are important here, because we can use them in our continuous integration.
