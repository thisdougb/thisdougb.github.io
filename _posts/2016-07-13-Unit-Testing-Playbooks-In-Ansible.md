...
But while talking to a client about their Ansible journey, I think I've become more receptive to unit testing of roles.
With a large number of DevOps engineers working on a bunch of roles the company found errors were becoming common.
...
And to be fair, in a complex setup with included files and variables, and multiple engineers, this sort of mistake is quite possible.
